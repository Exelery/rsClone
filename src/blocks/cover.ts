export default [
    ...
    html: true,
    name: 'LeftImageBlock',
    data: `<div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="https://bootstrap-5.ru/docs/5.1/examples/heroes/bootstrap-themes.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
      </div>
      <div class="col-lg-6">
...
},
{
  html: true,
  name: 'JoinUsBgImage',
  data: `<section class="fdb-block" style="background-image: url(https://heroic-empanada-f5b342.netlify.app/hero/blue.svg);">
  <div class="container">
    <div class="fdb-box">
  ...
  <div class="row">
    <div class="col-md-4">
      <img src="https://images.unsplash.com/photo-1542909168-82c3e7fdca5c" alt="Team Member 1" style="width:100%">
      <h2>Team Member 1</h2>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    </div>

    <div class="col-md-4">
      <img src="https://images.unsplash.com/photo-1542909168-82c3e7fdca5c" alt="Team Member 2" style="width:100%">
      <h2>Team Member 2</h2>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    </div>

    <div class="col-md-4">
      <img src="https://images.unsplash.com/photo-1542909168-82c3e7fdca5c" alt="Team Member 3" style="width:100%">
      <h2>Team Member 3</h2>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>               
    </div>             
  </div>          
